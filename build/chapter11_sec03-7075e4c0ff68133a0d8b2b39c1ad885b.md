...
den Dämpfer. Für $D = 1$ und $D = 2$ gibt es keinen Vorzeichenwechsel der
Auslenkung, der Arm kriecht monoton in den Ursprung. Die gedämpfte
**Eigenkreisfrequenz** beträgt $\omega_d = \omega_0\sqrt{1-D^2}$, was für $D <
1$ eine reelle Zahl ergibt.
