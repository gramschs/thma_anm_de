...
Schon mit 4 internen Schritten liegt `solve_ivp` näher an der analytischen
Lösung als Euler mit 500 Schritten. Der Unterschied liegt im Algorithmus: Euler
...
höherer Ordnung (hier 4./5. Ordnung) mit Fehler $O(\Delta t^4)$ statt $O(\Delta
t)$.
...
Zu Frage 3: 500 Euler-Schritte gegenüber 4 RK45-Schritten ergibt einen
Faktor von $500 / 4 = 125$. Da RK45 pro Schritt etwa sechs
Funktionsauswertungen benötigt, ist der Faktor bei den tatsächlichen
Funktionsauswertungen etwa $500 / 24 \approx 40$. Dennoch: für dieselbe
