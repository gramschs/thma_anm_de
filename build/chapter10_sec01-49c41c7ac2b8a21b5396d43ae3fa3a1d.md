...
Zu Frage 2: Der Fehler nach dem ersten Schritt ist positiv ($T_\text{Euler} >
T_\text{exakt}$). Das bedeutet, Euler überschätzt die Temperatur. Das Verfahren
nimmt an, dass die Abkühlrate während des gesamten Intervalls konstant bei
$-6.0~^{\circ}\text{C}/\text{min}$ bleibt. Tatsächlich sinkt die Rate aber schon
während des Schritts, weil die Temperaturdifferenz kleiner wird. Euler kühlt
daher zu wenig ab.
...
von etwa $0.8255\,°C$. Für $0.001\,°C$ braucht man rund die 825-fache Genauigkeit,
also grob $\Delta t \approx 0.0012\,\text{min}$. Das entspricht etwa 24750000 Schritten
