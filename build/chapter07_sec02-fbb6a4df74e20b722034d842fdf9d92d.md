...
Der Gesamtfehler setzt sich also aus zwei gegenläufigen Anteilen zusammen:
...
Das Minimum dieser Summe liegt bei der **optimalen Schrittweite**. Wir
leiten $E(\Delta x)$ nach $\Delta x$ ab, setzen die Ableitung gleich null
und lösen. Für die Vorwärtsdifferenz ergibt sich:
...
proportional zu $\Delta x^2$. Die analoge Rechnung liefert:
