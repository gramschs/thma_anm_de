...
1. Erzeugen Sie die Matrix in Python und geben Sie `.shape` aus.
...
\vec{b}$ direkt. Intern verwendet NumPy dabei eine LU-Zerlegung, die deutlich
effizienter ist als das von Hand durchgeführte Gaußsche Eliminationsverfahren.
