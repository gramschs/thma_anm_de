...
```{admonition} Zu diesen Übungen
:class: note
Diese Aufgaben sind für das Selbststudium zuhause gedacht und wiederholen den
Stoff der Kapitel 2.1 bis 2.4. Rechnen Sie mit rund 90 Minuten
Bearbeitungszeit.

Der Schwierigkeitsgrad steht im Titel jeder Aufgabe:

* ✩ Verständnis: Code und Ausgaben vorhersagen und erklären
* ✩✩ Anwendung: eigenen Code schreiben und Ergebnisse interpretieren
* ✩✩✩ Mini-Projekt: mehrere Konzepte des Parts kombinieren
```
