...
\begin{equation*} c_{\text{krit}} = 2 \sqrt{k \, m} \end{equation*}

nennen wir **kritische Dämpfung**. Für $c = c_{\text{krit}}$ gilt also $D = 1$.
Allgemein können wir den Dämpfungsgrad auch schreiben als

\begin{equation*} D = \frac{c}{c_{\text{krit}}}. \end{equation*}
