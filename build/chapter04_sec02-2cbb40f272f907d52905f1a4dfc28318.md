...
# Reduzierungsmaske: DOF-Indizes der freien Knoten
# Knoten n -> DOFs 2n (x) und 2n+1 (y)
reduzier_maske = []
...
print("Reduziermaske: ", reduzier_maske,
      " -> DOFs", ["x" if i % 2 == 0 else "y"
                   for i in reduzier_maske],
      "von Knoten", [i // 2 for i in reduzier_maske])
```

Die `reduzier_maske` enthält hier nur die Indizes `[2, 3]`, weil Knoten 1
der einzige freie Knoten ist. Das reduzierte LGS hat damit nur
$2 \times 2$ Einträge — genau zwei Unbekannte für die $x$- und
