...
* [ ] Sie können mit `np.linalg.matrix_rank()` den Rang einer Matrix
  berechnen und als allgemeineres Lösbarkeits­kriterium einsetzen.
```
...
kennen­gelernt. Wir wiederholen die wichtigsten Punkte kurz und direkt am
Obstmarkt-Beispiel.
...
z.B. `1.3e-15` lauten kann. `np.isclose(det_A, 0.0)` prüft statt­dessen,
