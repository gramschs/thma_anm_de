...
$v(t_i)$ ein. Der exakte Bremsweg ergibt sich dann aus dem bestimmten Integral
$s = \int_0^T v_0(1 - t/T)\,\mathrm{d}t$. Ausgerechnet liefert das $s =
v_0\left[t - \tfrac{t^2}{2T}\right]_0^T = v_0 \cdot \tfrac{T}{2}$.
