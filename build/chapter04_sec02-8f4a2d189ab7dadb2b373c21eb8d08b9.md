...
```{admonition} Hinweis: Festlager-Vereinfachung
:class: note

In der Praxis wäre Knoten 2 oft als Loslager ausgeführt, das nur $u_y$
sperrt (z. B. ein Rollenlager). Dann wäre der $x$-DOF von Knoten 2 frei,
und das reduzierte LGS hätte eine Zeile mehr. Für dieses Einführungsbeispiel
nehmen wir vereinfachend an, dass beide Lager alle Freiheitsgrade sperren.
```
