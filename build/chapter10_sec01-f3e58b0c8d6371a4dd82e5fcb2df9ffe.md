...
Die Temperatur nähert sich asymptotisch der Umgebungstemperatur $T_{\infty} = 20~^{\circ}\text{C}$. Nach 50 min
...
```{admonition} Mini-Übung
:class: tip
1. Lesen Sie aus dem Plot ab: Um welchen Faktor ändert sich der Fehler,
