...
Eckpunkt B liegt bei $(2, 0)$ und landet nach einer 90°-Drehung bei $(0, 2)$: er
wandert auf einem Kreisbogen von der positiven $x$-Achse zur positiven
$y$-Achse. Die Matrix-Vektor-Multiplikation $\mathbf{R} \cdot \vec{p}$ dreht den
Vektor $\vec{p}$ um den angegebenen Winkel um den Ursprung.
