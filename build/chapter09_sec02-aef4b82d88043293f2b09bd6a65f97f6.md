...
2. Berechnen Sie den analytischen Bremsweg $s_\text{exakt} = \int_0^T v_0\,e^{-k
   t}\,\mathrm{d}t = \frac{v_0}{k}(1 - e^{-kT})$ und vergleichen Sie mit dem
   numerischen Ergebnis. Wie groß ist der relative Fehler in Prozent?
