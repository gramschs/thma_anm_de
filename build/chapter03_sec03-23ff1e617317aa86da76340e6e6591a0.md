...
```{figure} bilder/waermeuebertragung_mehrschichtwand.svg
:alt: Querschnitt einer dreischichtigen Wand mit Temperaturprofil und Wärmestrom
:align: center

Temperaturprofil einer Mehrschichtwand im stationären Zustand. Die x-Achse entspricht dem kumulierten thermischen Widerstand; die Steigung des Profils ist in Schicht C am größten.
