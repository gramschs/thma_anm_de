...
Variante 1: Gieren dreht $(1,0,0)^\top$ zu $(0,1,0)^\top$; anschließendes
Nicken um $90°$ dreht die $y$-Achse nicht (Nicken dreht in der $xz$-Ebene),
also bleibt $(0,1,0)^\top$... nein: Nicken um $90°$ dreht $(0,1,0)^\top$
nicht, aber $(1,0,0)^\top$ wäre zu $(0,0,-1)^\top$ gegangen. Die Rechnung
ergibt $(0, 0, -1)^\top$ für Variante 1 und $(0, 1, 0)^\top$ für
Variante 2. Die Ergebnisse sind verschieden, weil
