...
Der horizontale Basisstab zwischen Knoten 0 und Knoten 2 steht unter Zug:
Die geneigten Stäbe üben horizontale Druckkräfte auf die Lager aus und
versuchen, diese auseinanderzudrücken. Der Basisstab verhindert dieses
Auseinanderdriften, indem er die Lager zusammenzieht – er wird also auf
Zug beansprucht. Das ist physikalisch plausibel.
````
...
Druckstäbe farblich zu unterscheiden.
