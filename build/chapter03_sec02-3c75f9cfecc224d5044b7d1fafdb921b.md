...
A_referenz[0, 0] = 99.0           # ändert auch A_original mit

print('A_original[0,0]:', A_original[0, 0])  # 99.0 -> unbeabsichtigt geändert!

# RICHTIG: .copy() erstellt eine echte, unabhängige Kopie
A_original = np.array([[3, 2, 1], [2, 3, 0], [1, 1, 3]], dtype=float)
A_kopie    = A_original.copy()    # echte Kopie
A_kopie[0, 0] = 99.0              # ändert nur A_kopie

print('A_original[0,0]:', A_original[0, 0])  # 3.0 -> unverändert
...
A_falsch = A.copy()        # Kopie anlegen, um A nicht zu verändern
