...
Wir erzeugen zunächst einen realistischen Bremsvorgang: das Fahrzeug startet bei
100 km/h und bremst gleichmäßig bis zum Stillstand in 5 Sekunden. Physikalisch
entspricht gleichmäßig bremsen einer **konstanten Verzögerung** $a$.  
Für konstante $a$ gilt $v(t) = v_0 + a t$; mit der Bedingung $v(T) = 0$ folgt $a
= -v_0/T$ und damit
...
nichtlinearen Geschwindigkeitsverlauf hätte die Mittelpunktregel ebenfalls einen
Fehler.
```
