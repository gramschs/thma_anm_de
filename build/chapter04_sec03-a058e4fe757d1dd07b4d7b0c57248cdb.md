...
Für ein ebenes Fachwerk mit $k$ Knoten und $m$ Stäben ergibt die notwendige
Bedingung für statische Bestimmtheit $m = 2k - 3$. Mit $k = 3$ und $m = 3$
lautet sie $3 \neq 2 \cdot 3 - 3 = 3$ — sie ist hier zufällig erfüllt.
Allgemein gilt: Verbindet ein zusätzlicher Stab zwei vollständig gelagerte
Knoten, so ist seine Kraft im Rahmen der linearen kleinen-Verformungstheorie
stets null, weil beide Endpunkte ortsfest sind. Ob der Stab im realen
Bauwerk eine Funktion übernimmt (z. B. Stabilisierung gegen seitliche Lasten),
