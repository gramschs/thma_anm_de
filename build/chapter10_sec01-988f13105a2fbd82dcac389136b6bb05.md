...
auch der Fehler ungefähr. Das bedeutet eine **Konvergenzordnung** von $O(\Delta
t)$. Das Euler-Verfahren wird deshalb als ein Verfahren erster Ordnung
bezeichnet. Zum Vergleich: Die Trapezregel aus Kapitel 9 hatte Ordnung $O(\Delta
t^2)$. In Abschnitt 10.3 lernen wir Verfahren kennen, die Ordnung 4 oder höher
erreichen.
