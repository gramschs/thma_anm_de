...
Temperaturprofil einer Mehrschichtwand im stationären Zustand (schematische Darstellung bei gleicher geometrischer Schichtdicke). Da der Wärmestrom durch alle Schichten gleich ist, ist die Steigung des Temperaturprofils proportional zum thermischen Widerstand der jeweiligen Schicht, in Schicht C am steilsten, in Schicht B am flachsten.
...
```{code-cell} python
# Temperaturdifferenzen ueber jede Schicht
# Delta_i = R_i * |Q|: je groesser der Widerstand, desto groesser der Sprung
delta_A = T_AB - T_LA
delta_B = T_BC - T_AB
delta_C = T_CR - T_BC
