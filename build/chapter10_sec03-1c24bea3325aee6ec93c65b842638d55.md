...
| RK45 in `solve_ivp` | höhere Ordnung (ca. 4./5. Ordnung) | adaptiv, automatisch | Standardfall in der Praxis |

Halbiert man die Schrittweite, sinkt der Fehler bei Euler auf die Hälfte, bei
RK45 wesentlich schneller (etwa mit einer Potenz zwischen $\Delta t^4$ und
$\Delta t^5$).
```
