...
In Kapitel 4.1 haben wir einzelne Diagramme erstellt. In der Ingenieurpraxis
...
# Schwingungssignale (wie in Kapitel 3)
A      = 5.0
daempf = 1.5
f      = 10.0
...
ax[0].plot(t, a,  color='steelblue', linewidth=1.5, label='Grundschwingung')
ax[1].plot(t, a2, color='tomato',    linewidth=1.5, label='Oberschwingung')
...
- Oben: das saubere Schwingungssignal `a` in `'steelblue'`
...
ax[0].plot(t, a,            color='steelblue', linewidth=1.5, label='Sauber')
...
farben  = ['steelblue', 'tomato', 'seagreen', 'darkorchid']
...
ax[0].plot(t, a, color='steelblue', linewidth=1.5)
...
ax[1].plot(t, a, color='steelblue', linewidth=1.5)
...
parameter = [
    (1.5, 5.0, 'Normalbetrieb',   'steelblue'),
    (0.3, 8.0, 'Ueberlastbetrieb', 'tomato'),
    (4.0, 3.0, 'Nachlauf',         'seagreen'),
]
