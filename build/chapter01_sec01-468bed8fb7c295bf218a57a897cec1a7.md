...
zu verwalten. Im nächsten Kapitel 1.2 wenden wir das Gelernte an einem
zusammenhängenden Prüfstandsprojekt an. In Kapitel 1.3 lernen wir dann die
Datenstrukturen **Liste** und **Dictionary** kennen und schreiben eigene
**Funktionen**, um wiederkehrende Berechnungen wie die Umrechnung von km/h in
m/s zu kapseln. In Kapitel 2 verwenden wir schließlich **NumPy** und
**Matplotlib**, um ganze Messreihen ohne Schleifen zu verarbeiten und grafisch
darzustellen.
